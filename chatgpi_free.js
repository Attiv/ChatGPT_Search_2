// ==UserScript==
// @name               ChatGPT Search_2
// @name:zh-CN         ChatGPT 搜索2
// @name:zh-SG         ChatGPT 搜索2
// @name:zh-TW         ChatGPT 搜索2
// @name:zh-HK         ChatGPT 搜索2
...
(function () {
  ...
  async function getAnswer(question, callback) {
    try {
      ...
      GM_xmlhttpRequest({
        method: "GET",
        url: "https://v1.apigpt.cn/?q=" + question + "&apitype=sql",
        // method: "POST",
      ...
      return function (event) {
        ...
        if (event.status === 200) {
          ...
          if (event.response) {
            ...
            const answer = event.response.ChatGPT_Answer;
        ...
        return function (stream) {
          ...
          reader.read().then(function processText({ done, value }) {
            ...
            if (responseItem.startsWith("data: {")) {
              const answer = JSON.parse(responseItem.slice(6)).message.content
                .parts[0];
              containerShow(answer);
